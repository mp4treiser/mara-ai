...
from src.core.orm.database import get_db, SessionLocal
...
def monitor_all_wallets_task(self):
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            # Получаем кошельки для мониторинга синхронно (только ARBITRUM)
...
def process_deposit_task(self, deposit_id: int):
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            # Получаем депозит по ID синхронно
...
def process_pending_deposits_task(self):
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            # Получаем все pending депозиты синхронно
            pending_deposits = db.query(WalletDeposit).filter(
...
def monitor_single_wallet_task(self, wallet_id: int):
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            # Получаем кошелек по ID синхронно
